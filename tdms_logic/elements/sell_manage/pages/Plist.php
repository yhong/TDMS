<center>
	<table align="center">
		<tr>
			<td>
				<form name="searchbox" method="GET" action="/<?=$ELEMENT?>/Plist">
				<input type="hidden" name="searchmode" value="1">
					<table bgcolor="#FAFAFF" width="100%" style=\"border-width:1px; border-color:rgb(0,0,153); border-style:solid;\" cellpadding="0" cellspacing="0" bordercolordark="white" bordercolorlight="black">
					<tr>
					<?
...
<table border="0" width="100%">
	<tr>
		...
		<td width="120" align="center" >
			<input type="button" value="새로등록(I)" onclick="location.href='/<?=$ELEMENT?>/Pinsert';" accesskey=I>
		</td>
	</tr>
</table>
</center>