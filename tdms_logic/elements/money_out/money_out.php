<?
Class money_out extends Element{
	private $Page;
	private $PageG;
	...
	public function Plist(){
		...
		// 검색 항목을 추가할 수 있습니다.
		$searchField = array("유형//","코드번호/10/10","지출내역/10/100");
		//////////////////////////////////////////////////
		$arrTbList = array(
							"일련번호"=>array("일련번호"),
							"유형별번호"=>array("유형","코드번호"),
	...
	*/
	public function Pinsert(){
		...
		$dbObj->AddElement2("유형별번호", 
							...
							"");
		$dbObj->AddElement($dbObj->formElement("날짜", date("Y-m-d"), ""), "");
		$dbObj->AddElement($dbObj->formElement("지출내역", "", ""), "");
		$dbObj->AddElement($dbObj->formElement("가격", "", ""), "");
