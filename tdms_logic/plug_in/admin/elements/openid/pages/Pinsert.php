...
<form name="Insertform" method="POST" action="/<?=$PLUGIN?>/<?=$ELEMENT?>/Pinsert_Action?<?=$strLink?>">
...
<td colspan="2">
	<p align="center">
		...
		&nbsp;&nbsp;
		<input type="button" value="목록보기(L)" onclick="location.href='/<?=$PLUGIN?>/<?=$ELEMENT?>/Plist?<?=$strLink?>';" accesskey="L">
	</p>
</td>
</tr>
</table>
