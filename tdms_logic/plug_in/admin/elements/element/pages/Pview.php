...
<tr>
	<td colspan="2">
		 <p align="center">
			<input type="button" value="목록보기(L)" onClick="location.href='/<?=$PLUGIN?>/<?=$ELEMENT?>/Plist'" accesskey="L">&nbsp;&nbsp;
			<input type="button" value="수정(E)" onClick="location.href='/<?=$PLUGIN?>/<?=$ELEMENT?>/Pupdate?id=<?=$_GET["id"]?>'" accesskey="E">&nbsp;&nbsp;
			<input type="button" value="삭제(D)" onClick="location.href='/<?=$PLUGIN?>/<?=$ELEMENT?>/Pdelete?id=<?=$_GET["id"]?>'" accesskey="D">
		</p>
	</td>
</tr>
